...
-- 索引: idx_trades_run (表: trades)
CREATE INDEX idx_trades_run ON public.trades USING btree (run_id);
...
ALTER TABLE public.trades ADD FOREIGN KEY (run_id) REFERENCES runs(run_id) ON DELETE CASCADE;
